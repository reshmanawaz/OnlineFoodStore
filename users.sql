...
INSERT INTO `cart` (`id`, `count`, `product_id`) VALUES
(13, 2, 1);
...
(1, 1, 'Apple', 1, 82, 130, 6),
(2, 1, 'Banana', 1, 118, 105, 15),
(3, 1, 'Orange', 1, 157, 118, 15),
(4, 0, 'Asparagus', 1, 134, 27, 15),
(5, 0, 'Tomato', 1, 149, 27, 15),
(6, 0, 'Lettuce', 1, 118, 105, 15);
